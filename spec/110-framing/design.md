...
- **Nano Cortex framing differences (if any) are provisional.** The protocol shape is shared; Nano-specific flag semantics or report layouts, if they exist, are not verified against hardware yet.